...
<div class="spacer_t1"></div>
<div class="row">
    <app:input id="numeroInstalacion" label="eti.visortarea.form.label.assistant.numeroInstalacion" value="${tarea.tecnico}" cells="4" cell_label="6" cell_input="6"  readonly="true"/>
    ...
    <app:input id="nombre" label="eti.visortarea.form.label.assistant.nombre" value="${tarea.nombre}" cells="4" cell_label="6" cell_input="6" readonly="true"/>
</div>
<div class="spacer_t1"></div>
<div class="row">
    <app:input id="telefono" label="eti.visortarea.form.label.assistant.telefono" value="${tarea.telefono}" cells="4" cell_label="6" cell_input="6" readonly="true"/>
