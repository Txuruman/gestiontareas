...
<div ng-controller="listAssistant-ctrl" ng-init="getInstallationAndTask()">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="spacer_t1"></div>
            <div class="row">
                <app:inputDate id="fechaCierre" label="eti.visortarea.form.label.assistant.fechaCierre" value="tarea.fechaCierre" cells="4" cell_label="6" cell_input="6" readonly="true"/>
                <app:inputDate id="fechaArchivo" label="eti.visortarea.form.label.assistant.fechaArchivo" value="tarea.fechaArchivo" cells="4" cell_label="6" cell_input="6" readonly="true"/>
            </div>
            <div class="spacer_t1"></div>
            <div class="row">
                <app:inputDate id="boFechaRecepcion" label="eti.visortarea.form.label.assistant.boFechaRecepcion" value="tarea.boFechaRecepcion" cells="4" cell_label="6" cell_input="6" readonly="true"/>
            ...
            <div class="spacer_t1"></div>
            <div class="row">
                <app:inputDate id="boFechaGestion" label="eti.visortarea.form.label.assistant.boFechaGestion" value="tarea.boFechaGestion" cells="4" cell_label="6" cell_input="6" readonly="true"/>
