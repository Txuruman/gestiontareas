        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="row">
			            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
			                <app:inputTextNG id="ninstalacion" label="createtask.installationnumber"
			                                 ...
			                                 cells="0" ng_keypress="($event.keyCode===13 && tarea.numeroInstalacion!='' && tarea.numeroInstalacion!=undefined && tarea.numeroInstalacion!=null) ? getIntallation($event) : null"/>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <app:inputTextNG pattern="^(?:(?:([01]?\d|2[0-3])))$" id="horarioDesde" label="tareaAviso.horarioDesde" form="formCreateTask" required="true" value="tarea.horarioDesde" cells="6"  ng_disabled="installationNotSearched" hour="true" clazz="sinPaddingRight" size="2" only="true"/><!--  ng_keypress="onlyNumber($event,true,tarea.horarioDesde.length)"/> -->
                		<app:inputTextNG pattern="^(?:(?:([01]?\d|2[0-3])))$" id="horarioHasta" label="tareaAviso.horarioHasta" form="formCreateTask" required="true" value="tarea.horarioHasta" cells="6"  ng_disabled="installationNotSearched" hour="true" clazz="sinPaddingRight" size="2" only="true"/>
                    </div>
                </div>
                <!-- row -->
                <div class="spacer_t1"></div>
                ...
                <div class="spacer_t1"></div>
                <!-- row -->
                <app:textAreaNG id="comment" value="tarea.observaciones" label="createtask.comment" cell_label="2" cell_input="10" ng_disabled="installationNotSearched" clazz="paddingLeft10"/>
            </div>
        </div>
        <!-- row -->
        <div class="spacer_t1"></div>
