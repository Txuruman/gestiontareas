        ...
        <ul>
            ...
            <li>Tarea tipo Excel
                <ul>
                    ...
                    <li><a href="visortarea.htm?bp_agent=12187&bp_agentCountryJob=SPAIN&bp_callingListManagedDesktop=ATC_SPN&bp_out_GSW_CHAIN_ID_CUSTOM=2&bp_out_clname=CL_CCT_XLS_LIMPIEZA_CUOTA">Tarea Tipo Excel Limpieza de cuota</a></li>
