angular.module('common', [])
    .controller('BaseFormCtrl', ['$scope', '$http', function ($scope, $http) {
        ...
        /** Funcion para processar las respuestas del servidor */
        $scope.processBaseResponse = function(data, status, headers, config) {
            $scope.serverMessages = data.messages;
            //TODO Si messages esta indefinido limpiar serverMessages
        };
