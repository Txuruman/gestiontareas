...
public class DiscardFeeCleaningTaskRequest extends BaseRequest {

    private TareaLimpiezaCuota task;

    private String prueba;

    public DiscardFeeCleaningTaskRequest() {
    }

    public DiscardFeeCleaningTaskRequest(TareaLimpiezaCuota task) {
        this.task = task;
    }
    ...
    public String toString() {
        return "DiscardFeeCleaningTaskRequest{" +
                "task=" + task +
                ", prueba='" + prueba + '\'' +
                '}';
    }
